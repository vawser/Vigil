...
$Event(11000, Default, function() {
    ...
    // Accursed
    //----------------------
    InitializeEvent(0, 11040, 0); // Award Notes after Death
    ...
    InitializeEvent(76, 13000, 6170, 6171, 6172, 1047590860, 1047590861, 1047590862); // Thumb Ring of Pharris
    InitializeEvent(77, 13000, 6180, 6181, 6182, 1047590870, 1047590871, 1047590872); // Vambrace of Trefin
    InitializeEvent(78, 13000, 6190, 6191, 6192, 1047590880, 1047590881, 1047590882); // Bracing Ring of Ergoth
    
    InitializeEvent(79, 13000, 6200, 6201, 6202, 1047590890, 1047590891, 1047590892); // Prisoner's Chain
...
//-------------------
// Accursed - Grant new Debuffs on death
//-------------------
$Event(11040, Restart, function() {
    EndIf(EventFlag(1047610025)); // Accursed run completed
    EndIf(!EventFlag(1047610154));
      
    // Grant new debuff item if the player dies
    WaitFor(CharacterHPValue(10000, Equal, 1) <= 0);
    
    BatchSetEventFlags(1047620000, 1047620044, OFF);
...
//-------------------
$Event(11048, Restart, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4) {
    if(EventFlag(X0_4))
    {
        StoreItemAmountHeldInEventValue(ItemType.Goods, X12_4, X8_4, 5);
...
//-------------------
$Event(11041, Default, function(X0_4, X4_4, X8_4) {
    EndIf(EventFlag(1047610025)); // Accursed run completed
    EndIf(!EventFlag(1047610154));
...
//-------------------
// Accursed - Apply Debuffs (5)
//-------------------
$Event(11042, Default, function(X0_4, X4_4, X8_4) {
    EndIf(EventFlag(1047610025)); // Accursed run completed
    EndIf(!EventFlag(1047610154));
...
//-------------------
// Accursed - Apply Debuffs (1)
//-------------------
$Event(11043, Default, function(X0_4, X4_4, X8_4) {
    EndIf(EventFlag(1047610025)); // Accursed run completed
    EndIf(!EventFlag(1047610154));
...
// Transmog
//-------------------
$Event(11100, Default, function() {
    // Heavy
    InitializeEvent(0, 11101, 9402028, 1047600028) // Bull-Goat Set [Head]
    InitializeEvent(1, 11101, 9402029, 1047600029) // Bull-Goat Set [Body]
    InitializeEvent(2, 11101, 9402112, 1047600112) // Fire Prelate Set [Head]
    InitializeEvent(3, 11101, 9402113, 1047600113) // Fire Prelate Set [Body]
    InitializeEvent(4, 11101, 9402114, 1047600114) // Fire Prelate Set (Altered) [Head]
    InitializeEvent(5, 11101, 9402115, 1047600115) // Fire Prelate Set (Altered) [Body]
    InitializeEvent(6, 11101, 9402300, 1047600300) // Omen Set [Head]
    InitializeEvent(7, 11101, 9402301, 1047600301) // Omen Set [Body]
    InitializeEvent(8, 11101, 9402176, 1047600176) // Lionel's Set [Head]
    InitializeEvent(9, 11101, 9402177, 1047600177) // Lionel's Set [Body]
    InitializeEvent(10, 11101, 9402178, 1047600178) // Lionel's Set (Altered) [Head]
    InitializeEvent(11, 11101, 9402179, 1047600179) // Lionel's Set (Altered) [Body]
    InitializeEvent(12, 11101, 9402072, 1047600072) // Tree Sentinel Set [Head]
    InitializeEvent(13, 11101, 9402073, 1047600073) // Tree Sentinel Set [Body]
    InitializeEvent(14, 11101, 9402074, 1047600074) // Tree Sentinel Set (Altered) [Head]
    InitializeEvent(15, 11101, 9402075, 1047600075) // Tree Sentinel Set (Altered) [Body]
    InitializeEvent(16, 11101, 9402220, 1047600220) // Veteran's Set [Head]
    InitializeEvent(17, 11101, 9402221, 1047600221) // Veteran's Set [Body]
    InitializeEvent(18, 11101, 9402222, 1047600222) // Veteran's Set (Altered) [Head]
    InitializeEvent(19, 11101, 9402223, 1047600223) // Veteran's Set (Altered) [Body]
    InitializeEvent(20, 11101, 9402203, 1047600203) // Beast Champion Set [Head]
    InitializeEvent(21, 11101, 9402204, 1047600204) // Beast Champion Set [Body]
    InitializeEvent(22, 11101, 9402205, 1047600205) // Beast Champion Set (Altered) [Head]
    InitializeEvent(23, 11101, 9402206, 1047600206) // Beast Champion Set (Altered) [Body]
    InitializeEvent(24, 11101, 9402046, 1047600046) // Banished Knight Set [Head]
    InitializeEvent(25, 11101, 9402047, 1047600047) // Banished Knight Set [Body]
    InitializeEvent(26, 11101, 9402048, 1047600048) // Banished Knight Set (Altered) [Head]
    InitializeEvent(27, 11101, 9402049, 1047600049) // Banished Knight Set (Altered) [Body]
    InitializeEvent(28, 11101, 9402131, 1047600131) // General Radahn's Set [Head]
    InitializeEvent(29, 11101, 9402132, 1047600132) // General Radahn's Set [Body]
    InitializeEvent(30, 11101, 9402133, 1047600133) // General Radahn's Set (Altered) [Head]
    InitializeEvent(31, 11101, 9402134, 1047600134) // General Radahn's Set (Altered) [Body]
    InitializeEvent(32, 11101, 9402070, 1047600070) // Malformed Dragon Set [Head]
    InitializeEvent(33, 11101, 9402071, 1047600071) // Malformed Dragon Set [Body]
    InitializeEvent(34, 11101, 9402008, 1047600008) // Scaled Set [Head]
    InitializeEvent(35, 11101, 9402009, 1047600009) // Scaled Set [Body]
    InitializeEvent(36, 11101, 9402010, 1047600010) // Scaled Set (Altered) [Head]
    InitializeEvent(37, 11101, 9402011, 1047600011) // Scaled Set (Altered) [Body]
    InitializeEvent(38, 11101, 9402145, 1047600145) // Crucible Axe Set [Head]
    InitializeEvent(39, 11101, 9402146, 1047600146) // Crucible Axe Set [Body]
    InitializeEvent(40, 11101, 9402147, 1047600147) // Crucible Axe Set (Altered) [Head]
    InitializeEvent(41, 11101, 9402148, 1047600148) // Crucible Axe Set (Altered) [Body]
    InitializeEvent(42, 11101, 9402149, 1047600149) // Crucible Tree Set [Head]
    InitializeEvent(43, 11101, 9402150, 1047600150) // Crucible Tree Set [Body]
    InitializeEvent(44, 11101, 9402076, 1047600076) // Royal Knight Set [Head]
    InitializeEvent(45, 11101, 9402077, 1047600077) // Royal Knight Set [Body]
    InitializeEvent(46, 11101, 9402078, 1047600078) // Royal Knight Set (Altered) [Head]
    InitializeEvent(47, 11101, 9402079, 1047600079) // Royal Knight Set (Altered) [Body]
    InitializeEvent(48, 11101, 9402104, 1047600104) // Cleanrot Set [Head]
    InitializeEvent(49, 11101, 9402105, 1047600105) // Cleanrot Set [Body]
    InitializeEvent(50, 11101, 9402106, 1047600106) // Cleanrot Set (Altered) [Head]
    InitializeEvent(51, 11101, 9402107, 1047600107) // Cleanrot Set (Altered) [Body]
    InitializeEvent(52, 11101, 9402036, 1047600036) // Blaidd's Set [Head]
    InitializeEvent(53, 11101, 9402037, 1047600037) // Blaidd's Set [Body]
    InitializeEvent(54, 11101, 9402038, 1047600038) // Blaidd's Set (Altered) [Head]
    InitializeEvent(55, 11101, 9402039, 1047600039) // Blaidd's Set (Altered) [Body]
    InitializeEvent(56, 11101, 9402058, 1047600058) // Night's Cavalry Set [Head]
    InitializeEvent(57, 11101, 9402059, 1047600059) // Night's Cavalry Set [Body]
    InitializeEvent(58, 11101, 9402060, 1047600060) // Night's Cavalry Set (Altered) [Head]
    InitializeEvent(59, 11101, 9402061, 1047600061) // Night's Cavalry Set (Altered) [Body]
    InitializeEvent(60, 11101, 9402212, 1047600212) // Maliketh's Set [Head]
    InitializeEvent(61, 11101, 9402213, 1047600213) // Maliketh's Set [Body]
    InitializeEvent(62, 11101, 9402214, 1047600214) // Maliketh's Set (Altered) [Head]
    InitializeEvent(63, 11101, 9402215, 1047600215) // Maliketh's Set (Altered) [Body]
    InitializeEvent(64, 11101, 9402159, 1047600159) // Twinned Set [Head]
    InitializeEvent(65, 11101, 9402160, 1047600160) // Twinned Set [Body]
    InitializeEvent(66, 11101, 9402161, 1047600161) // Twinned Set (Altered) [Head]
    InitializeEvent(67, 11101, 9402162, 1047600162) // Twinned Set (Altered) [Body]
    InitializeEvent(68, 11101, 9402180, 1047600180) // Hoslow's Set [Head]
    InitializeEvent(69, 11101, 9402181, 1047600181) // Hoslow's Set [Body]
    InitializeEvent(70, 11101, 9402182, 1047600182) // Hoslow's Set (Diallos) [Head]
    InitializeEvent(71, 11101, 9402183, 1047600183) // Hoslow's Set (Diallos) [Body]
    InitializeEvent(72, 11101, 9402184, 1047600184) // Hoslow's Set (Alt) [Head]
    InitializeEvent(73, 11101, 9402185, 1047600185) // Hoslow's Set (Alt) [Body]
    InitializeEvent(74, 11101, 9402368, 1047600368) // Cuckoo Knight Set [Head]
    InitializeEvent(75, 11101, 9402369, 1047600369) // Cuckoo Knight Set [Body]
    InitializeEvent(76, 11101, 9402370, 1047600370) // Cuckoo Knight Set (Altered) [Head]
    InitializeEvent(77, 11101, 9402371, 1047600371) // Cuckoo Knight Set (Altered) [Body]
    InitializeEvent(78, 11101, 9402050, 1047600050) // Briar Set [Head]
    InitializeEvent(79, 11101, 9402051, 1047600051) // Briar Set [Body]
    InitializeEvent(80, 11101, 9402052, 1047600052) // Briar Set (Altered) [Head]
    InitializeEvent(81, 11101, 9402053, 1047600053) // Briar Set (Altered) [Body]
    InitializeEvent(82, 11101, 9402364, 1047600364) // Godrick Knight Set [Head]
    InitializeEvent(83, 11101, 9402365, 1047600365) // Godrick Knight Set [Body]
    InitializeEvent(84, 11101, 9402366, 1047600366) // Godrick Knight Set (Altered) [Head]
    InitializeEvent(85, 11101, 9402367, 1047600367) // Godrick Knight Set (Altered) [Body]
    InitializeEvent(86, 11101, 9402376, 1047600376) // Redmane Knight Set [Head]
    InitializeEvent(87, 11101, 9402377, 1047600377) // Redmane Knight Set [Body]
    InitializeEvent(88, 11101, 9402378, 1047600378) // Redmane Knight Set (Altered) [Head]
    InitializeEvent(89, 11101, 9402379, 1047600379) // Redmane Knight Set (Altered) [Body]
    InitializeEvent(90, 11101, 9402360, 1047600360) // Gelmir Knight Set [Head]
    InitializeEvent(91, 11101, 9402361, 1047600361) // Gelmir Knight Set [Body]
    InitializeEvent(92, 11101, 9402362, 1047600362) // Gelmir Knight Set (Altered) [Head]
    InitializeEvent(93, 11101, 9402363, 1047600363) // Gelmir Knight Set (Altered) [Body]
    InitializeEvent(94, 11101, 9402372, 1047600372) // Leyndell Knight Set [Head]
    InitializeEvent(95, 11101, 9402373, 1047600373) // Leyndell Knight Set [Body]
    InitializeEvent(96, 11101, 9402374, 1047600374) // Leyndell Knight Set (Altered) [Head]
    InitializeEvent(97, 11101, 9402375, 1047600375) // Leyndell Knight Set (Altered) [Body]
    InitializeEvent(98, 11101, 9402384, 1047600384) // Haligtree Knight Set [Head]
    InitializeEvent(99, 11101, 9402385, 1047600385) // Haligtree Knight Set [Body]
    InitializeEvent(100, 11101, 9402386, 1047600386) // Haligtree Knight Set (Altered) [Head]
    InitializeEvent(101, 11101, 9402387, 1047600387) // Haligtree Knight Set (Altered) [Body]
    InitializeEvent(102, 11101, 9402110, 1047600110) // Blackflame Monk Set [Head]
    InitializeEvent(103, 11101, 9402111, 1047600111) // Blackflame Monk Set [Body]
    InitializeEvent(104, 11101, 9402108, 1047600108) // Fire Monk Set [Head]
    InitializeEvent(105, 11101, 9402109, 1047600109) // Fire Monk Set [Body]

    // Medium
    InitializeEvent(106, 11101, 9402155, 1047600155) // All-Knowing Set [Head]
    InitializeEvent(107, 11101, 9402156, 1047600156) // All-Knowing Set [Body]
    InitializeEvent(108, 11101, 9402157, 1047600157) // All-Knowing Set (Altered) [Head]
    InitializeEvent(109, 11101, 9402158, 1047600158) // All-Knowing Set (Altered) [Body]
    InitializeEvent(110, 11101, 9402196, 1047600196) // Royal Remains Set [Head]
    InitializeEvent(111, 11101, 9402197, 1047600197) // Royal Remains Set [Body]
    InitializeEvent(112, 11101, 9402224, 1047600224) // Bloodhound Knight Set [Head]
    InitializeEvent(113, 11101, 9402225, 1047600225) // Bloodhound Knight Set [Body]
    InitializeEvent(114, 11101, 9402226, 1047600226) // Bloodhound Knight Set (Altered) [Head]
    InitializeEvent(115, 11101, 9402227, 1047600227) // Bloodhound Knight Set (Altered) [Body]
    InitializeEvent(116, 11101, 9402345, 1047600345) // Knight Set [Head]
    InitializeEvent(117, 11101, 9402346, 1047600346) // Knight Set [Body]
    InitializeEvent(118, 11101, 9402286, 1047600286) // Fingerprint Set [Head]
    InitializeEvent(119, 11101, 9402287, 1047600287) // Fingerprint Set [Body]
    InitializeEvent(120, 11101, 9402288, 1047600288) // Fingerprint Set (Altered) [Head]
    InitializeEvent(121, 11101, 9402289, 1047600289) // Fingerprint Set (Altered) [Body]
    InitializeEvent(122, 11101, 9402302, 1047600302) // Carian Knight Set [Head]
    InitializeEvent(123, 11101, 9402303, 1047600303) // Carian Knight Set [Body]
    InitializeEvent(124, 11101, 9402304, 1047600304) // Carian Knight Set [Altered) [Head]
    InitializeEvent(125, 11101, 9402305, 1047600305) // Carian Knight Set [Altered) [Body]
    InitializeEvent(126, 11101, 9402348, 1047600348) // Godrick Soldier Set [Head]
    InitializeEvent(127, 11101, 9402349, 1047600349) // Godrick Soldier Set [Body]
    InitializeEvent(128, 11101, 9402350, 1047600350) // Raya Lucarian Soldier Set [Head]
    InitializeEvent(129, 11101, 9402351, 1047600351) // Raya Lucarian Soldier Set [Body]
    InitializeEvent(130, 11101, 9402352, 1047600352) // Leyndell Soldier Set [Head]
    InitializeEvent(131, 11101, 9402353, 1047600353) // Leyndell Soldier Set [Body]
    InitializeEvent(132, 11101, 9402354, 1047600354) // Radahn Soldier Set [Head]
    InitializeEvent(133, 11101, 9402355, 1047600355) // Radahn Soldier Set [Body]
    InitializeEvent(134, 11101, 9402358, 1047600358) // Haligtree Soldier Set [Head]
    InitializeEvent(135, 11101, 9402359, 1047600359) // Haligtree Soldier Set [Body]
    InitializeEvent(136, 11101, 9402250, 1047600250) // Raging Wolf Set [Head]
    InitializeEvent(137, 11101, 9402251, 1047600251) // Raging Wolf Set [Body]
    InitializeEvent(138, 11101, 9402252, 1047600252) // Raging Wolf Set (Altered) [Head]
    InitializeEvent(139, 11101, 9402253, 1047600253) // Raging Wolf Set (Altered) [Body]
    InitializeEvent(140, 11101, 9402186, 1047600186) // Vagabond Knight Set [Head]
    InitializeEvent(141, 11101, 9402187, 1047600187) // Vagabond Knight Set [Body]
    InitializeEvent(142, 11101, 9402188, 1047600188) // Vagabond Knight Set (Altered) [Head]
    InitializeEvent(143, 11101, 9402189, 1047600189) // Vagabond Knight Set (Altered) [Body]
    InitializeEvent(144, 11101, 9402380, 1047600380) // Mausoleum Knight Set [Head]
    InitializeEvent(145, 11101, 9402381, 1047600381) // Mausoleum Knight Set [Body]
    InitializeEvent(146, 11101, 9402382, 1047600382) // Mausoleum Knight Set (Altered) [Head]
    InitializeEvent(147, 11101, 9402383, 1047600383) // Mausoleum Knight Set (Altered) [Body]
    InitializeEvent(148, 11101, 9402282, 1047600282) // Eccentric's Set [Head]
    InitializeEvent(149, 11101, 9402283, 1047600283) // Eccentric's Set [Body]
    InitializeEvent(150, 11101, 9402284, 1047600284) // Eccentric's Set (Altered) [Head]
    InitializeEvent(151, 11101, 9402285, 1047600285) // Eccentric's Set (Altered) [Body]
    InitializeEvent(152, 11101, 9402004, 1047600004) // Drake Knight Set [Head]
    InitializeEvent(153, 11101, 9402005, 1047600005) // Drake Knight Set [Body]
    InitializeEvent(154, 11101, 9402006, 1047600006) // Drake Knight Set (Altered) [Head]
    InitializeEvent(155, 11101, 9402007, 1047600007) // Drake Knight Set (Altered) [Body]
    InitializeEvent(156, 11101, 9402040, 1047600040) // Black Knife Set [Head]
    InitializeEvent(157, 11101, 9402041, 1047600041) // Black Knife Set [Body]
    InitializeEvent(158, 11101, 9402042, 1047600042) // Black Knife Set (Altered) [Head]
    InitializeEvent(159, 11101, 9402043, 1047600043) // Black Knife Set (Altered) [Body]
    InitializeEvent(160, 11101, 9402044, 1047600044) // Exile Set [Head]
    InitializeEvent(161, 11101, 9402045, 1047600045) // Exile Set [Body]
    InitializeEvent(162, 11101, 9402127, 1047600127) // Elden Lord Set [Head]
    InitializeEvent(163, 11101, 9402128, 1047600128) // Elden Lord Set [Body]
    InitializeEvent(164, 11101, 9402129, 1047600129) // Elden Lord Set (Altered) [Head]
    InitializeEvent(165, 11101, 9402130, 1047600130) // Elden Lord Set (Altered) [Body]
    InitializeEvent(166, 11101, 9402030, 1047600030) // Ronin's Set [Head]
    InitializeEvent(167, 11101, 9402031, 1047600031) // Ronin's Set [Body]
    InitializeEvent(168, 11101, 9402032, 1047600032) // Ronin's Set (Altered) [Head]
    InitializeEvent(169, 11101, 9402033, 1047600033) // Ronin's Set (Altered) [Body]
    InitializeEvent(170, 11101, 9402331, 1047600331) // Chain Set [Head]
    InitializeEvent(171, 11101, 9402332, 1047600332) // Chain Set [Body]
    InitializeEvent(172, 11101, 9402000, 1047600000) // Iron Set [Head]
    InitializeEvent(173, 11101, 9402001, 1047600001) // Iron Set [Body]
    InitializeEvent(174, 11101, 9402002, 1047600002) // Kaiden Set [Head]
    InitializeEvent(175, 11101, 9402003, 1047600003) // Kaiden Set [Body]
    InitializeEvent(176, 11101, 9402356, 1047600356) // Mausoleum Soldier Set [Head]
    InitializeEvent(177, 11101, 9402357, 1047600357) // Mausoleum Soldier Set [Body]
    InitializeEvent(178, 11101, 9402062, 1047600062) // Blue Silver Set [Head]
    InitializeEvent(179, 11101, 9402063, 1047600063) // Blue Silver Set [Body]
    InitializeEvent(180, 11101, 9402064, 1047600064) // Blue Silver Set (Altered) [Head]
    InitializeEvent(181, 11101, 9402065, 1047600065) // Blue Silver Set (Altered) [Body]
    InitializeEvent(182, 11101, 9402322, 1047600322) // Zamor Set [Head]
    InitializeEvent(183, 11101, 9402323, 1047600323) // Zamor Set [Body]
    InitializeEvent(184, 11101, 9402216, 1047600216) // Malenia's Set [Head]
    InitializeEvent(185, 11101, 9402217, 1047600217) // Malenia's Set [Body]
    InitializeEvent(186, 11101, 9402218, 1047600218) // Malenia's Set (Altered) [Head]
    InitializeEvent(187, 11101, 9402219, 1047600219) // Malenia's Set (Altered) [Body]
    InitializeEvent(188, 11101, 9402100, 1047600100) // Guardian Set [Head]
    InitializeEvent(189, 11101, 9402101, 1047600101) // Guardian Set (Full Bloom) [Body]
    InitializeEvent(190, 11101, 9402102, 1047600102) // Guardian Set (Altered) [Head]
    InitializeEvent(191, 11101, 9402103, 1047600103) // Guardian Set (Altered) [Body]
    InitializeEvent(192, 11101, 9402094, 1047600094) // Duelist Set [Head]
    InitializeEvent(193, 11101, 9402095, 1047600095) // Duelist Set [Body]
    InitializeEvent(194, 11101, 9402096, 1047600096) // Duelist Set (Altered) [Head]
    InitializeEvent(195, 11101, 9402097, 1047600097) // Duelist Set (Altered) [Body]
    InitializeEvent(196, 11101, 9402254, 1047600254) // Land of Reeds Set [Head]
    InitializeEvent(197, 11101, 9402255, 1047600255) // Land of Reeds Set [Body]
    InitializeEvent(198, 11101, 9402256, 1047600256) // Land of Reeds Set (Altered) [Head]
    InitializeEvent(199, 11101, 9402257, 1047600257) // Land of Reeds Set (Altered) [Body]
    InitializeEvent(200, 11101, 9402258, 1047600258) // White Reed Set [Head]
    InitializeEvent(201, 11101, 9402259, 1047600259) // White Reed Set [Body]
    InitializeEvent(202, 11101, 9402388, 1047600388) // Godrick Foot Soldier Set [Head]
    InitializeEvent(203, 11101, 9402389, 1047600389) // Godrick Foot Soldier Set [Body]
    InitializeEvent(204, 11101, 9402390, 1047600390) // Raya Lucarian Foot Soldier Set [Head]
    InitializeEvent(205, 11101, 9402391, 1047600391) // Raya Lucarian Foot Soldier Set [Body]
    InitializeEvent(206, 11101, 9402392, 1047600392) // Leyndell Foot Soldier Set [Head]
    InitializeEvent(207, 11101, 9402393, 1047600393) // Leyndell Foot Soldier Set [Body]
    InitializeEvent(208, 11101, 9402394, 1047600394) // Radahn Foot Soldier Set [Head]
    InitializeEvent(209, 11101, 9402395, 1047600395) // Radahn Foot Soldier Set [Body]
    InitializeEvent(210, 11101, 9402396, 1047600396) // Haligtree Foot Soldier Set [Head]
    InitializeEvent(211, 11101, 9402397, 1047600397) // Haligtree Foot Soldier Set [Body]
    InitializeEvent(212, 11101, 9402084, 1047600084) // Nox Swordstress Set [Head]
    InitializeEvent(213, 11101, 9402085, 1047600085) // Nox Swordstress Set [Body]
    InitializeEvent(214, 11101, 9402086, 1047600086) // Nox Swordstress Set (Altered) [Head]
    InitializeEvent(215, 11101, 9402087, 1047600087) // Nox Swordstress Set (Altered) [Body]
    InitializeEvent(216, 11101, 9402088, 1047600088) // Night Maiden Set [Head]
    InitializeEvent(217, 11101, 9402089, 1047600089) // Night Maiden Set [Body]
    InitializeEvent(218, 11101, 9402260, 1047600260) // Confessor Set [Head]
    InitializeEvent(219, 11101, 9402261, 1047600261) // Confessor Set [Body]
    InitializeEvent(220, 11101, 9402262, 1047600262) // Confessor Set (Altered) [Head]
    InitializeEvent(221, 11101, 9402263, 1047600263) // Confessor Set (Altered) [Body]
    InitializeEvent(222, 11101, 9402080, 1047600080) // Nox Monk Set [Head]
    InitializeEvent(223, 11101, 9402081, 1047600081) // Nox Monk Set [Body]
    InitializeEvent(224, 11101, 9402082, 1047600082) // Nox Monk Set (Altered) [Head]
    InitializeEvent(225, 11101, 9402083, 1047600083) // Nox Monk Set (Altered) [Body]
    InitializeEvent(226, 11101, 9402122, 1047600122) // Vulgar Militia Set [Head]
    InitializeEvent(227, 11101, 9402123, 1047600123) // Vulgar Militia Set [Body]
    InitializeEvent(228, 11101, 9402163, 1047600163) // Ragged Set [Head]
    InitializeEvent(229, 11101, 9402164, 1047600164) // Ragged Set [Body]
    InitializeEvent(230, 11101, 9402165, 1047600165) // Ragged Set (Altered) [Head]
    InitializeEvent(231, 11101, 9402166, 1047600166) // Ragged Set (Altered) [Body]
    InitializeEvent(232, 11101, 9402190, 1047600190) // Blue Cloth Set [Head]
    InitializeEvent(233, 11101, 9402191, 1047600191) // Blue Cloth Set [Body]
    InitializeEvent(234, 11101, 9402398, 1047600398) // Omenkiller Set [Head]
    InitializeEvent(235, 11101, 9402399, 1047600399) // Omenkiller Set [Body]
    InitializeEvent(236, 11101, 9402342, 1047600342) // Leather Set [Head]
    InitializeEvent(237, 11101, 9402343, 1047600343) // Leather Set [Body]
    InitializeEvent(238, 11101, 9402192, 1047600192) // War Surgeon Set [Head]
    InitializeEvent(239, 11101, 9402193, 1047600193) // War Surgeon Set [Body]
    InitializeEvent(240, 11101, 9402194, 1047600194) // War Surgeon Set (Altered) [Head]
    InitializeEvent(241, 11101, 9402195, 1047600195) // War Surgeon Set (Altered) [Body]
    InitializeEvent(242, 11101, 9402280, 1047600280) // Raptor's Set [Head]
    InitializeEvent(243, 11101, 9402281, 1047600281) // Raptor's Set [Body]
    InitializeEvent(244, 11101, 9402275, 1047600275) // Preceptor's Set [Head]
    InitializeEvent(245, 11101, 9402276, 1047600276) // Preceptor's Set [Body]
    InitializeEvent(246, 11101, 9402277, 1047600277) // Preceptor's Set (Altered) [Head]
    InitializeEvent(247, 11101, 9402278, 1047600278) // Preceptor's Set (Altered) [Body]
    InitializeEvent(248, 11101, 9402415, 1047600415) // Rotten Duelist Set [Head]
    InitializeEvent(249, 11101, 9402416, 1047600416) // Rotten Duelist Set [Body]
    InitializeEvent(250, 11101, 9402417, 1047600417) // Rotten Duelist Set (Altered) [Head]
    InitializeEvent(251, 11101, 9402418, 1047600418) // Rotten Duelist Set (Altered) [Body]

    // Light
        InitializeEvent(252, 11101, 9402066, 1047600066) // Nomadic Merchant Set [Head]
    InitializeEvent(253, 11101, 9402067, 1047600067) // Nomadic Merchant Set [Body]
    InitializeEvent(254, 11101, 9402068, 1047600068) // Nomadic Merchant Set (Altered) [Head]
    InitializeEvent(255, 11101, 9402069, 1047600069) // Nomadic Merchant Set (Altered) [Body]
    InitializeEvent(256, 11101, 9402153, 1047600153) // Azur's Set [Head]
    InitializeEvent(257, 11101, 9402154, 1047600154) // Azur's Set [Body]
    InitializeEvent(258, 11101, 9402151, 1047600151) // Lusat's Set [Head]
    InitializeEvent(259, 11101, 9402152, 1047600152) // Lusat's Set [Body]
    InitializeEvent(260, 11101, 9402209, 1047600209) // Noble's Set (Crimson) [Head]
    InitializeEvent(261, 11101, 9402210, 1047600210) // Noble's Set (Crimson) [Body]
    InitializeEvent(262, 11101, 9402264, 1047600264) // Prisoner Set [Head]
    InitializeEvent(263, 11101, 9402265, 1047600265) // Prisoner Set [Body]
    InitializeEvent(264, 11101, 9402207, 1047600207) // Champion Set [Head]
    InitializeEvent(265, 11101, 9402208, 1047600208) // Champion Set [Body]
    InitializeEvent(266, 11101, 9402409, 1047600409) // Highwayman Set [Head]
    InitializeEvent(267, 11101, 9402410, 1047600410) // Highwayman Set [Body]
    InitializeEvent(268, 11101, 9402141, 1047600141) // Depraved Perfumer Set [Head]
    InitializeEvent(269, 11101, 9402142, 1047600142) // Depraved Perfumer Set [Body]
    InitializeEvent(270, 11101, 9402143, 1047600143) // Depraved Perfumer Set (Altered) [Head]
    InitializeEvent(271, 11101, 9402144, 1047600144) // Depraved Perfumer Set (Altered) [Body]
    InitializeEvent(272, 11101, 9402172, 1047600172) // Astrologer Set [Head]
    InitializeEvent(273, 11101, 9402173, 1047600173) // Astrologer Set [Body]
    InitializeEvent(274, 11101, 9402174, 1047600174) // Astrologer Set (Altered) [Head]
    InitializeEvent(275, 11101, 9402175, 1047600175) // Astrologer Set (Altered) [Body]
    InitializeEvent(276, 11101, 9402320, 1047600320) // Albinauric Set [Head]
    InitializeEvent(277, 11101, 9402321, 1047600321) // Albinauric Set [Body]
    InitializeEvent(278, 11101, 9402247, 1047600247) // Marionette Soldier Set [Head]
    InitializeEvent(279, 11101, 9402248, 1047600248) // Marionette Soldier Set [Body]
    InitializeEvent(280, 11101, 9402139, 1047600139) // Godskin Noble Set [Head]
    InitializeEvent(281, 11101, 9402140, 1047600140) // Godskin Noble Set [Body]
    InitializeEvent(282, 11101, 9402338, 1047600338) // Mushroom Set [Head]
    InitializeEvent(283, 11101, 9402339, 1047600339) // Mushroom Set [Body]
    InitializeEvent(284, 11101, 9402090, 1047600090) // Ancestral Fur Set [Head]
    InitializeEvent(285, 11101, 9402091, 1047600091) // Ancestral Fur Set [Body]
    InitializeEvent(286, 11101, 9402092, 1047600092) // Ancestral Shaman Set [Head]
    InitializeEvent(287, 11101, 9402093, 1047600093) // Ancestral Shaman Set [Body]
    InitializeEvent(288, 11101, 9402306, 1047600306) // Errant Sorcerer Set [Head]
    InitializeEvent(289, 11101, 9402307, 1047600307) // Errant Sorcerer Set [Body]
    InitializeEvent(290, 11101, 9402308, 1047600308) // Errant Sorcerer Set (Altered) [Head]
    InitializeEvent(291, 11101, 9402309, 1047600309) // Errant Sorcerer Set (Altered) [Body]
    InitializeEvent(292, 11101, 9402267, 1047600267) // Traveling Maiden Set [Head]
    InitializeEvent(293, 11101, 9402268, 1047600268) // Traveling Maiden Set [Body]
    InitializeEvent(294, 11101, 9402269, 1047600269) // Traveling Maiden Set (Altered) [Head]
    InitializeEvent(295, 11101, 9402270, 1047600270) // Traveling Maiden Set (Altered) [Body]
    InitializeEvent(296, 11101, 9402135, 1047600135) // Queen's Set [Head]
    InitializeEvent(297, 11101, 9402136, 1047600136) // Queen's Set [Body]
    InitializeEvent(298, 11101, 9402271, 1047600271) // Finger Maiden Set [Head]
    InitializeEvent(299, 11101, 9402272, 1047600272) // Finger Maiden Set [Body]
    InitializeEvent(300, 11101, 9402273, 1047600273) // Finger Maiden Set (Altered) [Head]
    InitializeEvent(301, 11101, 9402274, 1047600274) // Finger Maiden Set (Altered) [Body]
    InitializeEvent(302, 11101, 9402137, 1047600137) // Godskin Apostle Set [Head]
    InitializeEvent(303, 11101, 9402138, 1047600138) // Godskin Apostle Set [Body]
    InitializeEvent(304, 11101, 9402312, 1047600312) // Snow Witch Set [Head]
    InitializeEvent(305, 11101, 9402313, 1047600313) // Snow Witch Set [Body]
    InitializeEvent(306, 11101, 9402314, 1047600314) // Snow Witch Set (Altered) [Head]
    InitializeEvent(307, 11101, 9402315, 1047600315) // Snow Witch Set (Altered) [Body]
    InitializeEvent(308, 11101, 9402012, 1047600012) // Perfumer Set [Head]
    InitializeEvent(309, 11101, 9402013, 1047600013) // Perfumer Set [Body]
    InitializeEvent(310, 11101, 9402014, 1047600014) // Perfumer Set (Altered) [Head]
    InitializeEvent(311, 11101, 9402015, 1047600015) // Perfumer Set (Altered) [Body]
    InitializeEvent(312, 11101, 9402167, 1047600167) // Prophet Set [Head]
    InitializeEvent(313, 11101, 9402168, 1047600168) // Prophet Set [Body]
    InitializeEvent(314, 11101, 9402169, 1047600169) // Prophet Set (Altered) [Head]
    InitializeEvent(315, 11101, 9402170, 1047600170) // Prophet Set (Altered) [Body]
    InitializeEvent(316, 11101, 9402171, 1047600171) // Prophet Set (Alt) [Body]
    InitializeEvent(317, 11101, 9402310, 1047600310) // Battlemage Set [Head]
    InitializeEvent(318, 11101, 9402311, 1047600311) // Battlemage Set [Body]
    InitializeEvent(319, 11101, 9402290, 1047600290) // Consort's Set [Head]
    InitializeEvent(320, 11101, 9402291, 1047600291) // Consort's Set [Body]
    InitializeEvent(321, 11101, 9402124, 1047600124) // Sage Set [Head]
    InitializeEvent(322, 11101, 9402125, 1047600125) // Sage Set [Body]
    InitializeEvent(323, 11101, 9402318, 1047600318) // Goldmask's Set [Head]
    InitializeEvent(324, 11101, 9402319, 1047600319) // Goldmask's Set [Body]
    InitializeEvent(325, 11101, 9402020, 1047600020) // Alberich's Set [Head]
    InitializeEvent(326, 11101, 9402021, 1047600021) // Alberich's Set [Body]
    InitializeEvent(327, 11101, 9402022, 1047600022) // Alberich's Set (Altered) [Head]
    InitializeEvent(328, 11101, 9402023, 1047600023) // Alberich's Set (Altered) [Body]
    InitializeEvent(329, 11101, 9402116, 1047600116) // Aristocrat Set [Head]
    InitializeEvent(330, 11101, 9402117, 1047600117) // Aristocrat Set [Body]
    InitializeEvent(331, 11101, 9402118, 1047600118) // Wandering Aristocrat Set [Head]
    InitializeEvent(332, 11101, 9402119, 1047600119) // Wandering Aristocrat Set [Body]
    InitializeEvent(333, 11101, 9402120, 1047600120) // Old Aristocrat Set [Head]
    InitializeEvent(334, 11101, 9402121, 1047600121) // Old Aristocrat Set [Body]
    InitializeEvent(335, 11101, 9402054, 1047600054) // Page Set [Head]
    InitializeEvent(336, 11101, 9402055, 1047600055) // Page Set [Body]
    InitializeEvent(337, 11101, 9402056, 1047600056) // Page Set (Altered) [Head]
    InitializeEvent(338, 11101, 9402057, 1047600057) // Page Set (Altered) [Body]
    InitializeEvent(339, 11101, 9402098, 1047600098) // Sanguine Noble Set [Head]
    InitializeEvent(340, 11101, 9402099, 1047600099) // Sanguine Noble Set [Body]
    InitializeEvent(341, 11101, 9402198, 1047600198) // Brave's Set [Head]
    InitializeEvent(342, 11101, 9402199, 1047600199) // Brave's Set [Body]
    InitializeEvent(343, 11101, 9402200, 1047600200) // Brave's Set (Altered) [Head]
    InitializeEvent(344, 11101, 9402201, 1047600201) // Brave's Set (Altered) [Body]
    InitializeEvent(345, 11101, 9402016, 1047600016) // Travelling Perfumer Set [Head]
    InitializeEvent(346, 11101, 9402017, 1047600017) // Travelling Perfumer Set [Body]
    InitializeEvent(347, 11101, 9402018, 1047600018) // Travelling Perfumer Set (Altered) [Head]
    InitializeEvent(348, 11101, 9402019, 1047600019) // Travelling Perfumer Set (Altered) [Body]
    InitializeEvent(349, 11101, 9402024, 1047600024) // Spellblade Set [Head]
    InitializeEvent(350, 11101, 9402025, 1047600025) // Spellblade Set [Body]
    InitializeEvent(351, 11101, 9402026, 1047600026) // Spellblade Set (Altered) [Head]
    InitializeEvent(352, 11101, 9402027, 1047600027) // Spellblade Set (Altered) [Body]
    InitializeEvent(353, 11101, 9402234, 1047600234) // Commoner's Set [Head]
    InitializeEvent(354, 11101, 9402235, 1047600235) // Commoner's Set [Body]
    InitializeEvent(355, 11101, 9402236, 1047600236) // Commoner's Set (Altered) [Head]
    InitializeEvent(356, 11101, 9402237, 1047600237) // Commoner's Set (Altered) [Body]
    InitializeEvent(357, 11101, 9402238, 1047600238) // Simple Commoner's Set [Head]
    InitializeEvent(358, 11101, 9402239, 1047600239) // Simple Commoner's Set [Body]
    InitializeEvent(359, 11101, 9402292, 1047600292) // Ruler's Set [Head]
    InitializeEvent(360, 11101, 9402293, 1047600293) // Ruler's Set [Body]
    InitializeEvent(361, 11101, 9402294, 1047600294) // Upper-Class Set [Head]
    InitializeEvent(362, 11101, 9402295, 1047600295) // Upper-Class Set [Body]
    InitializeEvent(363, 11101, 9402405, 1047600405) // Fia's Set [Head]
    InitializeEvent(364, 11101, 9402406, 1047600406) // Fia's Set [Body]
    InitializeEvent(365, 11101, 9402407, 1047600407) // Fia's Set (Altered) [Head]
    InitializeEvent(366, 11101, 9402408, 1047600408) // Fia's Set (Altered) [Body]
    InitializeEvent(367, 11101, 9402411, 1047600411) // High Page Set [Head]
    InitializeEvent(368, 11101, 9402412, 1047600412) // High Page Set [Body]
    InitializeEvent(369, 11101, 9402413, 1047600413) // High Page Set (Altered) [Head]
    InitializeEvent(370, 11101, 9402414, 1047600414) // High Page Set (Altered) [Body]
    InitializeEvent(371, 11101, 9402034, 1047600034) // Guilty Set [Head]
    InitializeEvent(372, 11101, 9402035, 1047600035) // Guilty Set [Body]
    InitializeEvent(373, 11101, 9402296, 1047600296) // Marais Set [Head]
    InitializeEvent(374, 11101, 9402297, 1047600297) // Marais Set [Body]
    InitializeEvent(375, 11101, 9402298, 1047600298) // Bloodsoaked Set [Head]
    InitializeEvent(376, 11101, 9402299, 1047600299) // Bloodsoaked Set [Body]
    InitializeEvent(377, 11101, 9402228, 1047600228) // Festive Set [Head]
    InitializeEvent(378, 11101, 9402229, 1047600229) // Festive Set [Body]
    InitializeEvent(379, 11101, 9402230, 1047600230) // Festive Set (Altered) [Head]
    InitializeEvent(380, 11101, 9402231, 1047600231) // Festive Set (Altered) [Body]
    InitializeEvent(381, 11101, 9402232, 1047600232) // Blue Festive Set [Head]
    InitializeEvent(382, 11101, 9402233, 1047600233) // Blue Festive Set [Body]
    InitializeEvent(383, 11101, 9402316, 1047600316) // Juvenile Scholar Set [Head]
    InitializeEvent(384, 11101, 9402317, 1047600317) // Juvenile Scholar Set [Body]

    // Unique (Head)
    InitializeEvent(385, 11101, 9402344, 1047600344) // Bandit Mask [Head]
    InitializeEvent(386, 11101, 9402126, 1047600126) // Pumpkin Helm [Head]
    InitializeEvent(387, 11101, 9402202, 1047600202) // Brave's Leather Helm [Head]
    InitializeEvent(388, 11101, 9402211, 1047600211) // Navy Hood [Head]
    InitializeEvent(389, 11101, 9402240, 1047600240) // Envoy Crown [Head]
    InitializeEvent(390, 11101, 9402241, 1047600241) // Twinsage Glintstone Crown [Head]
    InitializeEvent(391, 11101, 9402242, 1047600242) // Raya Lucaria Scholar Set [Body]
    InitializeEvent(392, 11101, 9402243, 1047600243) // Olivinus Glintstone Crown [Head]
    InitializeEvent(393, 11101, 9402244, 1047600244) // Lazuli Glintstone Crown [Head]
    InitializeEvent(394, 11101, 9402245, 1047600245) // Karolos Glintstone Crown [Head]
    InitializeEvent(395, 11101, 9402246, 1047600246) // Witch's Glintstone Crown [Head]
    InitializeEvent(396, 11101, 9402249, 1047600249) // Marionette Soldier Birdhelm [Head]
    InitializeEvent(397, 11101, 9402266, 1047600266) // Blackguard's Iron Mask [Head]
    InitializeEvent(398, 11101, 9402279, 1047600279) // Grass Hair Ornament [Head]
    InitializeEvent(399, 11101, 9402324, 1047600324) // Imp Head (Cat) [Head]
    InitializeEvent(400, 11101, 9402325, 1047600325) // Imp Head (Fanged) [Head]
    InitializeEvent(401, 11101, 9402326, 1047600326) // Imp Head (Long-Tongued) [Head]
    InitializeEvent(402, 11101, 9402327, 1047600327) // Imp Head (Corpse) [Head]
    InitializeEvent(403, 11101, 9402328, 1047600328) // Imp Head (Wolf) [Head]
    InitializeEvent(404, 11101, 9402329, 1047600329) // Imp Head (Elder) [Head]
    InitializeEvent(405, 11101, 9402330, 1047600330) // Silver Tear Mask [Head]
    InitializeEvent(406, 11101, 9402333, 1047600333) // Greathelm [Head]
    InitializeEvent(407, 11101, 9402336, 1047600336) // Octopus Head [Head]
    InitializeEvent(408, 11101, 9402337, 1047600337) // Jar [Head]
    InitializeEvent(409, 11101, 9402340, 1047600340) // Nox Mirrorhelm [Head]
    InitializeEvent(410, 11101, 9402341, 1047600341) // Iji's Mirrorhelm [Head]
    InitializeEvent(411, 11101, 9402347, 1047600347) // Greathood [Head]
    InitializeEvent(412, 11101, 9402400, 1047600400) // Ash-of-War Scarab [Head]
    InitializeEvent(413, 11101, 9402401, 1047600401) // Incantation Scarab [Head]
    InitializeEvent(414, 11101, 9402402, 1047600402) // Glintstone Scarab [Head]
    InitializeEvent(415, 11101, 9402403, 1047600403) // Crimson Tear Scarab [Head]
    InitializeEvent(416, 11101, 9402404, 1047600404) // Cerulean Tear Scarab [Head]
    InitializeEvent(417, 11101, 9402419, 1047600419) // Mushroom Crown [Head]
    InitializeEvent(418, 11101, 9402420, 1047600420) // Black Dumpling [Head]
    InitializeEvent(419, 11101, 9402422, 1047600422) // Crab Carcass [Head]

    // Unique (Body)
    InitializeEvent(420, 11101, 9402421, 1047600421) // Lazuli Robe [Body]
    InitializeEvent(421, 11101, 9402334, 1047600334) // Eye Surcoat [Body]
    InitializeEvent(422, 11101, 9402335, 1047600335) // Tree Surcoat [Body]
    InitializeEvent(423, 11101, 9402423, 1047600423) // Millicent's Set [Body]
    InitializeEvent(424, 11101, 9402424, 1047600424) // Rotten Set [Body]
...
// Apply Override on Flag
$Event(11101, Default, function(X0_4, X4_4) {
    if(EventFlag(X4_4))
    {
    ...
    {
        if(CharacterHasSpEffect(10000, X0_4, Equal, 1))
        {
            ClearSpEffect(10000, X0_4);
        }
    }
    
    // Triggered by ESD menu when something is changed
    // This is to reduce the impact of the 400+ instances of this function
    WaitFor(EventFlag(1047610101)); 
