...
def t000004070_1():
    ...
    t000004070_x5(flag1=3223, flag2=3221, flag3=3222, val1=5, val2=10, val3=12, val4=30, val5=30, actionbutton1=6210,
...
def t000004070_2000():
    """State 0,2,3"""
    assert t000004070_x36()
    """State 1"""
    c1_120(2000)
    Quit()

def t000004070_x0(actionbutton1=6210, flag5=6001, flag9=6000, flag10=6000, flag11=6000, flag12=6000,
                  flag4=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t000004070_x3(val2=10, val3=12):
    """State 0,1"""
...
def t000004070_x5(flag1=3223, flag2=3221, flag3=3222, val1=5, val2=10, val3=12, val4=30, val5=30, actionbutton1=6210,
                  flag4=6000, flag5=6001, flag6=6000, flag7=6000, flag8=6000, z1=1, z2=1000000, z3=1000000,
                  z4=1000000, mode1=1, mode2=1):
    """State 0"""
    ...
    while True:
        """State 2"""
        call = t000004070_x22(flag1=flag1, flag2=flag2, flag3=flag3, val1=val1, val2=val2, val3=val3,
...
def t000004070_x6(val1=5, val2=10, val3=12, val4=30, val5=30, actionbutton1=6210, flag4=6000, flag5=6001,
                  flag6=6000, flag7=6000, flag8=6000, z1=1, z2=1000000, z3=1000000, z4=1000000, mode1=1,
                  mode2=1):
    """State 0"""
    while True:
        """State 2"""
        call = t000004070_x9(actionbutton1=actionbutton1, flag4=flag4, flag5=flag5, z2=z2, z3=z3, z4=z4)
        def WhilePaused():
        ...
        if call.Done():
            ...
            Label('L0')
            c1_138(1000000)
            call = t000004070_x13(val1=val1, z1=z1)
            def WhilePaused():
            ...
            """State 6"""
            assert t000004070_x26() and CheckSpecificPersonTalkHasEnded(0) == 1
            continue
        ...
        def ExitPause():
            RemoveMyAggro()
        assert t000004070_x11(val2=val2, val3=val3)
    """Unused"""
    """State 7"""
    return 0

def t000004070_x7(val2=10, val3=12):
    """State 0,1"""
    call = t000004070_x17(val2=val2, val3=val3)
    assert IsPlayerDead() == 1
    """State 2"""
    t000004070_x3(val2=val2, val3=val3)
    Quit()
    """Unused"""
    """State 3"""
    return 0

def t000004070_x8(flag1=3223, val2=10, val3=12):
    """State 0,8"""
    assert t000004070_x34()
    """State 1"""
...
def t000004070_x9(actionbutton1=6210, flag4=6000, flag5=6001, z2=1000000, z3=1000000, z4=1000000):
    """State 0,1"""
    call = t000004070_x10(z6=2000, val6=2000)
    if call.Get() == 1:
        """State 2"""
        assert (t000004070_x0(actionbutton1=actionbutton1, flag5=flag5, flag9=6000, flag10=6000, flag11=6000,
...
def t000004070_x10(z6=_, val6=_):
    """State 0,1"""
    if f203(z6) == 1:
        """State 2"""
...
def t000004070_x11(val2=10, val3=12):
    """State 0"""
    assert GetCurrentStateElapsedFrames() > 1
    """State 5"""
    assert t000004070_x1()
...
def t000004070_x12():
    """State 0,1"""
    assert t000004070_x10(z6=1101, val6=1101)
    """State 2"""
    return 0

def t000004070_x13(val1=5, z1=1):
    """State 0,2"""
    assert t000004070_x23()
    """State 1"""
    call = t000004070_x14()
    if call.Done():
        pass
        ...
        """State 3"""
        assert t000004070_x25()
    """State 4"""
    return 0

def t000004070_x14():
    """State 0,1"""
    assert t000004070_x10(z6=1000, val6=1000)
    """State 2"""
    return 0

def t000004070_x15(val5=30):
    """State 0,1"""
    call = t000004070_x16()
    if call.Done():
        pass
        ...
        """State 2"""
        assert t000004070_x26()
    """State 3"""
    return 0

def t000004070_x16():
    """State 0,1"""
    assert t000004070_x10(z6=1100, val6=1100)
    """State 2"""
    return 0

def t000004070_x17(val2=10, val3=12):
    """State 0,5"""
    assert t000004070_x34()
    """State 2"""
...
def t000004070_x18():
    """State 0,2"""
    call = t000004070_x10(z6=1102, val6=1102)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t000004070_x19():
    """State 0,1"""
    assert t000004070_x10(z6=1001, val6=1001)
    """State 2"""
    return 0

def t000004070_x20():
    """State 0,1"""
    assert t000004070_x10(z6=1103, val6=1103)
    """State 2"""
    return 0
...
def t000004070_x22(flag1=3223, flag2=3221, flag3=3222, val1=5, val2=10, val3=12, val4=30, val5=30, actionbutton1=6210,
                   flag4=6000, flag5=6001, flag6=6000, flag7=6000, flag8=6000, z1=1, z2=1000000, z3=1000000,
                   z4=1000000, mode1=1, mode2=1):
    """State 0"""
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t000004070_x6(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, actionbutton1=actionbutton1,
                             flag4=flag4, flag5=flag5, flag6=flag6, flag7=flag7, flag8=flag8, z1=z1,
                             z2=z2, z3=z3, z4=z4, mode1=mode1, mode2=mode2)
        if CheckSelfDeath() == 1 or GetEventFlag(flag1) == 1:
            """State 3"""
            Label('L0')
            call = t000004070_x8(flag1=flag1, val2=val2, val3=val3)
            ...
            """State 2"""
            call = t000004070_x7(val2=val2, val3=val3)
            if CheckSelfDeath() == 1 or GetEventFlag(flag1) == 1:
                Goto('L0')
            ...
            pass
        """State 4"""
        assert t000004070_x33() and (not GetEventFlag(9000) and not IsPlayerDead())
    """Unused"""
    """State 5"""
    return 0
...
def t000004070_x23():
    """State 0,1"""
    assert t000004070_x24()
    """State 2"""
    return 0

def t000004070_x24():
    """State 0,1"""
    assert t000004070_x10(z6=1104, val6=1104)
    """State 2"""
    return 0

def t000004070_x25():
    """State 0,1"""
    call = t000004070_x10(z6=1201, val6=1201)
    if call.Get() == 1:
        """State 2"""
        assert t000004070_x4()
    elif call.Done():
        pass
    """State 3"""
    return 0
...
def t000004070_x26():
    """State 0,1"""
    call = t000004070_x10(z6=1300, val6=1300)
    if call.Get() == 1:
        """State 2"""
        assert t000004070_x4()
    elif call.Done():
...
def t000004070_x27():
    """State 0,1"""
    call = t000004070_x10(z6=1301, val6=1301)
    if call.Get() == 1:
        """State 2"""
        assert t000004070_x4()
    elif call.Done():
...
def t000004070_x28():
    """State 0,1"""
    call = t000004070_x10(z6=1302, val6=1302)
    if call.Get() == 1:
        """State 2"""
        assert t000004070_x4()
    elif call.Done():
...
def t000004070_x29(text2=_, mode4=1):
    """State 0,4"""
    assert t000004070_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
...
def t000004070_x30(text1=_, z5=_, mode3=1):
    """State 0,5"""
    assert t000004070_x31() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 2"""
    SetEventFlag(z5, 1)
    """State 1"""
...
def t000004070_x32():
    """State 0,1"""
    assert t000004070_x10(z6=1002, val6=1002)
    """State 2"""
    return 0
...
def t000004070_x35():
    assert CheckSpecificPersonTalkHasEnded(0) == 1
    """State 8"""
    assert t000004070_x100()
    """State 9"""
    return 0

def t000004070_x36():
    """State 0,1"""
    assert t000004070_x0(actionbutton1=6210, flag5=6001, flag9=6000, flag10=6000, flag11=6000, flag12=6000, flag4=6000)
...
def t000004070_x101():
    while True:
        ...
        if GetTalkListEntryResult() == 1:
            assert t000004070_x111(1047610350)
            return 0
        elif GetTalkListEntryResult() == 2:
            assert t000004070_x111(1047610351)
            return 0
        elif GetTalkListEntryResult() == 3:
            assert t000004070_x111(1047610352)
            return 0
        elif GetTalkListEntryResult() == 4:
            assert t000004070_x111(1047610353)
            return 0
        elif GetTalkListEntryResult() == 5:
            assert t000004070_x111(1047610354)
            return 0
        elif GetTalkListEntryResult() == 6:
            assert t000004070_x111(1047610355)
            return 0
        elif GetTalkListEntryResult() == 7:
            assert t000004070_x111(1047610356)
            return 0
        elif GetTalkListEntryResult() == 8:
            assert t000004070_x111(1047610357)
            return 0
        elif GetTalkListEntryResult() == 9:
            assert t000004070_x111(1047610358)
            return 0
        elif GetTalkListEntryResult() == 10:
            assert t000004070_x111(1047610359)
            return 0
        elif GetTalkListEntryResult() == 11:
            assert t000004070_x111(1047610360)
            return 0
        elif GetTalkListEntryResult() == 12:
            assert t000004070_x111(1047610361)
            return 0
        elif GetTalkListEntryResult() == 13:
            assert t000004070_x111(1047610362)
            return 0
        elif GetTalkListEntryResult() == 14:
            assert t000004070_x111(1047610363)
            return 0
        elif GetTalkListEntryResult() == 15:
            assert t000004070_x111(1047610364)
            return 0
        elif GetTalkListEntryResult() == 16:
            assert t000004070_x111(1047610365)
            return 0
        elif GetTalkListEntryResult() == 17:
            assert t000004070_x111(1047610366)
            return 0
        elif GetTalkListEntryResult() == 18:
            assert t000004070_x111(1047610367)
            return 0
        elif GetTalkListEntryResult() == 19:
            assert t000004070_x111(1047610368)
            return 0
        elif GetTalkListEntryResult() == 20:
            assert t000004070_x111(1047610369)
            return 0
        elif GetTalkListEntryResult() == 21:
            assert t000004070_x111(1047610370)
            return 0
        elif GetTalkListEntryResult() == 22:
            assert t000004070_x111(1047610371)
            return 0
        elif GetTalkListEntryResult() == 23:
            assert t000004070_x111(1047610372)
            return 0
...
# Set Theme
def t000004070_x111(flag=_):
    assert t000004070_x110(80105700)
